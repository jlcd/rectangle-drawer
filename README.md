...
This repository was 99% AI generated (thanks [cline](https://github.com/cline/cline) and [Claude](https://claude.com/claude-code)). I left the "icon creation" setup here as is, as I found it a novel idea that allowed the AI to fully create the extension (including images).
